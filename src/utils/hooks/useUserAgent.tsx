...
/**
 * Custom React hook to detect browser type and whether or not it's being accessed from mobile.
 *
 * Not sure if we will need to use this or not so just keeping it here for reference
 *
 * source: https://medium.com/designly/creating-an-install-to-home-screen-prompt-in-a-next-js-progressive-web-app-588a3e7a6747
 * @returns
 */
